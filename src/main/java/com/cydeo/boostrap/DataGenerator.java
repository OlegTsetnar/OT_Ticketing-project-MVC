...
public class DataGenerator implements CommandLineRunner {
    ...
    //when we put @Component --> roleService gives error. In this case we should put @Component in "RoleServiceImpl" class, we could not do that in interface class
    ...
    public void run(String... args) throws Exception {
        ...
        //add data to map --> because we used MAP as DB in "impl package"
...
//        roleService.save(employeeRole);
        ...
        TaskDTO task4 = new TaskDTO(project2, user7, "Dependency Injection", "Autowired", Status.COMPLETE, LocalDate.now().minusDays(20));
